...
function isAffix(tag: { meta: { affix: any } }) {
...
function closeAllTags(view: { name: string; fullPath: string }|undefined) {
...
function openMenu(tag: any, e: { clientX: number; clientY: number }) {
